...
seriously. If you believe you have found a security issue in ORY Buildbuf Action,
...
Buildbuf Action's normal direction. A great way to
do this is via
[ORY Buildbuf Action Discussions](https://github.com/ory/meta/discussions)
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out ORY Buildbuf Action.
...
- **Helping with open issues.** We have a lot of open issues for ORY Buildbuf Action
...
Check out [ORY Buildbuf Action Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to ORY Buildbuf Action,
...
before getting started to ensure your work is consistent with ORY Buildbuf Action's
...
[docs](https://github.com/ory/build-buf-action/tree/master/docs) folder. Generate API and
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Buildbuf Action
