...
# Contribute to Ory Buildbuf Action<!-- omit in toc -->
...
won't clash with Ory Buildbuf Action's direction. A great way to do this is via
[Ory Buildbuf Action Discussions](https://github.com/orgs/ory/discussions) or
...
- **Help with open issues.** We have a lot of open issues for Ory Buildbuf
...
Check out
[Ory Buildbuf Action Discussions](https://github.com/orgs/ory/discussions). This
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/build-buf-action/blob/master/.github/workflows/conventional_commits.yml)
