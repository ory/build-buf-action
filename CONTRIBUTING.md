...
# Contributing to Ory Buildbuf Action
...
_Please note_: We take Ory Buildbuf Action's security and our users' trust very
seriously. If you believe you have found a security issue in Ory Buildbuf
...
won't clash or be obviated by Ory Buildbuf Action's normal direction. A great
way to do this is via
[Ory Buildbuf Action Discussions](https://github.com/ory/meta/discussions) or
the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/build-buf-action/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory Buildbuf Action?](#communication)
...
- I want to talk to other Ory Buildbuf Action users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory Buildbuf
  Action. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/build-buf-action)

- I would like updates about new versions of Ory Buildbuf Action.
...
[list of good first issues](https://github.com/ory/build-buf-action/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Buildbuf
...
- **Helping with open issues.** We have a lot of open issues for Ory Buildbuf
...
Check out
[Ory Buildbuf Action Discussions](https://github.com/ory/meta/discussions). This
...
If you want to receive regular notifications about updates to Ory Buildbuf
...
before getting started to ensure your work is consistent with Ory Buildbuf
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Buildbuf Action](https://github.com/ory/build-buf-action/blob/master/.github/semantic.yml)
   for an overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/build-buf-action).
...
[docs](https://github.com/ory/build-buf-action/tree/master/docs) folder.
Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/build-buf-action/blob/master/README.md).
...
git clone git@github.com:ory/ory/build-buf-action.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/build-buf-action.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Buildbuf
  Action core team immediately.
